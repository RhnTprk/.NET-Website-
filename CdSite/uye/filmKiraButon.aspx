<%@ Page Title="" Language="C#" MasterPageFile="~/uye/uyePaneller.Master" AutoEventWireup="true" CodeBehind="filmKiraButon.aspx.cs" Inherits="CdSite.uye.filmKiraButon" %>
...
">
        ...
        <div style="height: 199px; margin-top: 20px">
            ...
            <asp:Button ID="btn_kirala" runat="server" Height="45px" Text="Kirala" Width="129px" Style="margin-left: 156px" OnClick="btn_kirala_Click" ValidationGroup="bg" />
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Label ID="Label2" runat="server" Style="font-weight: 700; font-size: xx-large; color: #0000CC" Text="Teslim Tarihi :"></asp:Label>
            &nbsp;<asp:Label ID="lbl_ttarih" runat="server" Style="font-weight: 700; color: #CC0000; font-size: xx-large"></asp:Label>

            &nbsp;
            <asp:Button ID="btn_arttır" runat="server" Height="20px" OnClick="btn_arttır_Click" Text="+" Width="25px" />
