...
{
    public partial class filmKiraGuncelle : System.Web.UI.Page
    {
        public int _k_id { get { return Session["Ukiralayan_id"] == null ? 0 : int.Parse(Session["Ukiralayan_id"].ToString()); } }
