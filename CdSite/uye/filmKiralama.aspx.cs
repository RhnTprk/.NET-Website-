...
{
    public partial class filmKiralama : System.Web.UI.Page
    {
        ...
        protected void btn_kirala_Click(object sender, EventArgs e)
        {
            ...
            {
                Session["Ukiralanacak_id"] = liste.DataKeys[index].Value;
                Response.Redirect("filmKiraButon.aspx");
            }
        }
        ...
        protected void kListe_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Session["Ukiralayan_id"] = kListe.DataKeys[index].Values[2];
        }
        ...
        protected void btn_sil_Click(object sender, EventArgs e)
        {
            ...
            {
                var sil = _dc.tx_filmKiras.FirstOrDefault(s => s.id.Equals(Session["Ukiralayan_id"]));
        ...
        protected void btn_guncelle_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("filmKiraGuncelle.aspx");
            }
        }
