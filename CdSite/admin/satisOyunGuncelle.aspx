<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Paneller.Master" AutoEventWireup="true" CodeBehind="satisOyunGuncelle.aspx.cs" Inherits="CdSite.admin.satisOyunGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <div style="height: 506px; width: 741px;">
        <div style="height: 178px">
            ...
            <asp:Label ID="Label4" runat="server" Style="color: #000066; font-weight: 700; font-size: x-large" Text="Oyun Adı :"></asp:Label>
            &nbsp;<asp:Label ID="lbl_oyunad" runat="server" Style="color: #CC0000; font-weight: 700; font-size: x-large"></asp:Label>
