<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Paneller.Master" AutoEventWireup="true" CodeBehind="btnKguncelle.aspx.cs" Inherits="CdSite.admin.btnKguncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="height: 577px">
        ...
        <div style="margin-top: 30px">
            <asp:Button ID="btn_ekle" runat="server" Text="Güncelle" Height="39px" Width="140px" Style="margin-left: 203px" OnClick="btn_ekle_Click" ValidationGroup="bg" />
        </div>
    </div>
</asp:Content>
