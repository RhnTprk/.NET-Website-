<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Paneller.Master" AutoEventWireup="true" CodeBehind="kiralayanGuncelle.aspx.cs" Inherits="CdSite.admin.kiralayanGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="height: 506px; width: 741px;">
        <div style="height: 178px">
            ...
            <asp:Label ID="Label4" runat="server" Style="color: #000066; font-weight: 700; font-size: x-large" Text="Film Adı :"></asp:Label>
            &nbsp;<asp:Label ID="lbl_filmad" runat="server" Style="color: #CC0000; font-weight: 700; font-size: x-large"></asp:Label>
        ...
        <div style="width: 353px">
            <div style="width: 100px; float: left; margin-left: 10px; margin-top: 12px;"><strong style="color: #CC0000">Teslim Tarihi:</strong></div>
            <asp:TextBox ID="txt_ttarih" runat="server" Style="width: 200px; height: 35px; line-height: 45px; margin-left: 5px; border-radius: 5px;"></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator3" runat="server" ErrorMessage="**" ControlToValidate="txt_ttarih" Display="Dynamic" Font-Bold="true" ForeColor="Maroon" Font-Size="Large" ValidationGroup="bg" Operator="DataTypeCheck" Type="Date" SetFocusOnError="True"></asp:CompareValidator>

        </div>
        <div style="width: 353px">
            <div style="width: 100px; float: left; margin-left: 10px; margin-top: 12px;"><strong style="color: #CC0000">İade Tarih:</strong></div>
            <asp:TextBox ID="txt_itarih" runat="server" Style="width: 200px; height: 35px; line-height: 45px; margin-left: 5px; border-radius: 5px;"></asp:TextBox>
            <asp:CompareValidator ID="CompareValidator2" runat="server" ErrorMessage="**" ControlToValidate="txt_itarih" Display="Dynamic" Font-Bold="true" ForeColor="Maroon" Font-Size="Large" ValidationGroup="bg" Operator="DataTypeCheck" Type="Date" SetFocusOnError="True"></asp:CompareValidator>
        </div>
        <div style="width: 353px">
